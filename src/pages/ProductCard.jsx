...
function ProductCard({ product, addToCart }) {
    const [isExpanded, setIsExpanded] = useState(false);
    const [isAdded, setIsAdded] = useState(false);  // Track if product is added to the cart
    ...
    const handleAddToCart = () => {
        // Add the product to the cart and show confirmation toast
        addToCart(product);
        setIsAdded(true);
        toast({
            title: "Added to Cart",
        ...
        >
            ...
            <CardBody>
                <Stack mt="4" spacing="3">
                    ...
                    {/* Description: Show full or truncated text */}
                    <Text fontSize="sm" color="gray.500">
                        {isExpanded
                            ? product.description
                            : `${product.description.substring(0, 60)}...`}
            ...
            {/* Card Footer: Add to Cart and Buy Now buttons */}
            <CardFooter display="flex" justifyContent="space-between">
                <ButtonGroup spacing="3">
                    <Button
                        colorScheme="blue"
                        ...
                        isDisabled={isAdded} // Disable button if already added
                    >
